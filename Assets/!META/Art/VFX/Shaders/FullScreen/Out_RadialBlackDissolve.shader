Shader "VFX-GAME/General/Out_RadialBlackDissolve"
{   
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag (Varyings input) : SV_Target
            {
                ...
                float dissolveValue = normalizedDist - (noiseVal * _NoiseIntensity);
                float threshold = _DissolveAmount * (1.0 + _NoiseIntensity) - _NoiseIntensity;
                
                float mask = step(threshold, dissolveValue);
